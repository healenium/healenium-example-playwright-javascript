...
test.describe('Locator API - iframe - Tests', () => {
  ...
  test('iframe - change frame title - input field expect', async ({ page }) => {
    ...
    const iframe = page.frameLocator('xpath=//*[@id=\'iframe_id\']');
  ...
  test('iframe - change all nested path', async ({ page }) => {
    ...
    const inputField = page.frameLocator('xpath=//*[@id=\'iframe_id\']').frameLocator('xpath=//*[@id=\'iframe_2_id\']').locator('xpath=//*[@id=\'newId_iframe2\']');
    await expect(inputField).toBeVisible();

    // Click iframe Change locators button 
    const iframeSubmitBtn = page.frameLocator('xpath=//*[@id=\'iframe_id\']').locator('#iframe_Submit');
    ...
    // Test healing - same action should work after locator change
    const healedInputField = page.frameLocator('xpath=//*[@id=\'iframe_id\']').frameLocator('xpath=//*[@id=\'iframe_2_id\']').locator('xpath=//*[@id=\'newId_iframe2\']');
    await expect(healedInputField).toBeVisible();
