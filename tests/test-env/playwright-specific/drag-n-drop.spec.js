...
test.describe('Locator API - Drag Ang Drop - Tests', () => {
  ...
  test('source - playwright-specific', async ({ page }) => {
    ...
    const droppableElement = page.locator('//*[@id=\'new_drop_id\']');
    ...
    const healedDroppableElement = page.locator('//*[@id=\'new_drop_id\']');
  ...
  test('page.dragAndDrop', async ({ page }) => {
    ...
    await page.dragAndDrop('//div[@class="drag-container"]/div[@name="dragRed"]', '//*[@id=\'new_drop_id\']', { timeout: TIMEOUT });
